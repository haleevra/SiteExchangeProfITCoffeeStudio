...
Функция ПолучитьТоварыJSON(id)
	...
	ТоварыЗаписьJSON = Новый ЗаписьJSON();
	
	ТоварыЗаписьJSON.ЗаписатьНачалоОбъекта();
	ТоварыЗаписьJSON.ЗаписатьИмяСвойства("Objects");
	ТоварыЗаписьJSON.ЗаписатьНачалоМассива();
	...
	Пока Выборка.Следующий() Цикл 
		...
		ФабрикаXDTO.ЗаписатьJSON(ТоварыЗаписьJSON, ПолучитьОбъектXDTO(НоменклатураОбъект));
	...
	//ТоварыЗаписьJSON.ЗаписатьКонецОбъекта();
	Возврат ТоварыЗаписьJSON.Закрыть();	
КонецФункции
...
//
Процедура ЗаписатьДанные(СписокОбъектов, Данные) Экспорт
...
Функция ПолучитьОбъектXDTO(Данные)
	...
	Попытка
		...
		Если ТипЗнч(Данные) = Тип("СправочникОбъект.Номенклатура") Тогда
			...
			ПередаваемыйОбъект.IsGroup = Данные.ЭтоГруппа;
